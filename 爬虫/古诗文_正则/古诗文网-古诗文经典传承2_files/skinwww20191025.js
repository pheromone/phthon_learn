...
function OnYiwen(id) {
    //取消背诵
    document.getElementById("btnBeisong" + id).src = "https://song.gushiwen.org/siteimg/beipic.png";
    ...
    if (document.getElementById("btnYiwen" + id).alt == "译文" && document.getElementById("btnZhushi" + id).alt == "注释" && document.getElementById("btnShangxi" + id).alt == "赏析") {
        document.getElementById("btnYiwen" + id).src = "https://song.gushiwen.org/siteimg/yipic2.png";
        ...
        document.getElementById("btnYiwen" + id).src = "https://song.gushiwen.org/siteimg/yipic.png";
...
function OnZhushi(id) {
    ...
    var value = "cont";
    if (document.getElementById("btnYiwen" + id).alt == "译文" && document.getElementById("btnZhushi" + id).alt == "注释" && document.getElementById("btnShangxi" + id).alt == "赏析") {
        document.getElementById("btnZhushi" + id).src = "https://song.gushiwen.org/siteimg/zhupic2.png";
        ...
        document.getElementById("btnZhushi" + id).src = "https://song.gushiwen.org/siteimg/zhupic.png";
...
function OnShangxi(id) {
    ...
    var value = "cont";
    if (document.getElementById("btnYiwen" + id).alt == "译文" && document.getElementById("btnZhushi" + id).alt == "注释" && document.getElementById("btnShangxi" + id).alt == "赏析") {
        document.getElementById("btnShangxi" + id).src = "https://song.gushiwen.org/siteimg/shangpic2.png";
        ...
        document.getElementById("btnShangxi" + id).src = "https://song.gushiwen.org/siteimg/shangpic.png";
...
function OnBeisong(id,from) {
    if (getCookie('gsw2017user') == null) {
        ...
        if (document.getElementById("btnBeisong" + id).alt == "背诵") {
            ...
            document.getElementById("btnBeisong" + id).src = "https://song.gushiwen.org/siteimg/beipic2.png";
...
function clickType() {
    if (document.getElementById("type1").style.height == "auto") {
        document.getElementById("imgType1").src = "https://song.gushiwen.org/siteimg/jianTop.png";
        document.getElementById("type1").style.height = "26px";

    }
    else {
        document.getElementById("imgType1").src = "https://song.gushiwen.org/siteimg/jianBtn.png";
...
function clickType2() {
    if (document.getElementById("type2").style.height == "auto") {
        document.getElementById("imgType2").src = "https://song.gushiwen.org/siteimg/jianTop.png";
        document.getElementById("type2").style.height = "26px";
    }
    else {
        document.getElementById("imgType2").src = "https://song.gushiwen.org/siteimg/jianBtn.png";
...
function clickType3() {
    if (document.getElementById("type3").style.height == "auto") {
        document.getElementById("imgType3").src = "https://song.gushiwen.org/siteimg/jianTop.png";
        document.getElementById("type3").style.height = "26px";
    }
    else {
        document.getElementById("imgType3").src = "https://song.gushiwen.org/siteimg/jianBtn.png";
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if (document.getElementById('shangxiPlay' + id).style.display == "block") {
                document.getElementById('speakerimgShangxiquan' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
            }
        }
    }
    ...
    if (document.getElementById('toolPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimg' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
    ...
    if (document.getElementById('shangxiPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgShangxi' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
    ...
    if (document.getElementById('fanyiPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgFanyi' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
    ...
    if (document.getElementById('ziliaoPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgZiliao' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
    ...
    if (document.getElementById('authorPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgAuthor' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
    ...
    if (document.getElementById('bookvPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBookv' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
    ...
    if (document.getElementById('bvfanyiPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBvfanyi' + id).src = "https://song.gushiwen.org/siteimg/speakerOk.png";
...
(function() {
    ...
    E.appendChild(I);
    I.innerHTML = '<img src="https://song.gushiwen.org/siteimg/loading.gif" width="32" height="32" />';
    var l = e("iframe");
